  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-[900px] mx-auto px-5 py-16">
        <h1 className="text-center mb-12 uppercase tracking-wider">Privacy Policy</h1>
        
        <div className="space-y-8 text-gray-700">
          <section>
            <p className="text-sm mb-4"><em>Last updated: December 12, 2025</em></p>
            <p className="leading-relaxed">
              At TEALHOUSE, we are committed to protecting your privacy and ensuring the security of your personal information. 
          ...
          <section>
            ...
            <div className="space-y-4">
              ...
              <div>
                <h3 className="mb-2">Automatically Collected Information</h3>
                <p className="leading-relaxed mb-2">
          ...
          <section>
            ...
            <p className="leading-relaxed mb-3">
              We use cookies and similar technologies to enhance your browsing experience. You can control cookie preferences 
              through your browser settings. Our cookies include:
            </p>
            <ul className="list-disc list-inside space-y-2 ml-4">
          ...
          <section>
            ...
            <p className="leading-relaxed">
              ...
              safeguards are in place to protect your information in accordance with this Privacy Policy and applicable law.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="leading-relaxed">
              ...
              through a notice on our website. The "Last updated" date at the top indicates when this policy was last revised.
            </p>
          </section>
          ...
          <section className="bg-gray-50 p-6 border border-gray-200">
            <h2 className="mb-3">GDPR & CCPA Compliance</h2>
            <p className="leading-relaxed">
