-- TEALHOUSE: Seed 4 signature products with proper RLS handling
-- Run this in your Supabase SQL Editor

-- STEP 1: Temporarily disable RLS for products table to allow seeding
ALTER TABLE products DISABLE ROW LEVEL SECURITY;

-- STEP 2: Delete all existing products (clean slate)
DELETE FROM products;

-- STEP 3: Insert the 4 TEALHOUSE signature products
INSERT INTO products (name, price, image, images, video, category, categories, audience, description, materials, sizes, created_at, updated_at)
VALUES
  (
    'Lexi',
    1250.00,
...
-- STEP 4: Re-enable RLS for products table
...
-- STEP 6: Recreate policies for products (public read, authenticated write)
...
-- STEP 7: Fix storage bucket and policies
