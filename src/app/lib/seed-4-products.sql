-- Insert 4 TEALHOUSE signature products
-- Run this in your Supabase SQL Editor: https://supabase.com/dashboard/project/ymnqgfpnfzrlinbdbkel/sql

INSERT INTO products (name, price, images, video, categories, audience, description, materials, sizes, created_at, updated_at)
VALUES
  (
    'Lexi',
    1250.00,
...
-- Verify the insert
SELECT id, name, price, categories, audience, array_length(images, 1) as image_count
FROM products
